...
public final class ClientHighlightLogic {
    ...
    public static void onHighlightResponse(Iterable<BlockPos> positions) {
        ...
        if (changed && !ClientHighlightState.isEmpty() && Utils.getConfig().highlightBlocksMessage) {
            Messages.clientMessage(
                    Component.translatable("vm.message.highlightblocks", ClientHighlightState.size()),
                    true
            );
        }
    }
